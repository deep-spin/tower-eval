...
from tower_eval.metrics.metricx_qe_xxl.result import MetricXQEXXLResult
...
class MetricXQEXXL(Metric):
    def __init__(
        self,
        lowercase: bool = False,
        tokenizer="google/mt5-xxl",
        model="google/metricx-23-qe-xxl-v2p0",
        **kwargs
    ) -> None:
    ...
    def evaluate(self, hypotheses: list, sources: list) -> MetricXQEXXLResult:
        """
        ...
        metricx_result = MetricXQEXXLResult(
            {
