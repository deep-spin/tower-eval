...
from tower_eval.metrics.metricx_xxl.result import MetricXXXLResult
...
class MetricXXXL(Metric):
    ...
    def evaluate(self, hypotheses: list, references: list) -> MetricXXXLResult:
        """
        ...
        metricx_result = MetricXXXLResult(
            {
